...
| T11 vonly | 15254796 | 240f, W_I=0 W_KCL=0 | ep20/30 unseen **0.820** (still ↓, train 0.573) | WINNING again -> matches s0=0.824. Confirms T02: exact decoder couples I to V, so explicit I loss is redundant AND injects stiff reactor/xfmr gradients (reactor 8.7e14%, xfmr 2666%) that fight V. Drop I loss; currents stay machine-exact from decoder. LIKELY the full-launch config |
| T12 stability | 15254801 (s2) | 240f s2: ic-clamp + warmup 0.1 | ep16/30 unseen 0.983 | current-loss-on: barely under null, learning slowly. s1 (15254800/15255130) DIED 3x -- teardown shm-unlink race ('could not unlink shared memory file'), a worker exits early under file_system sharing; SEED-1 data-order specific, NOT a model signal. Not resurrecting: s0/vonly/pf/s2 are the evidence base |
| T13 fix matrix | 15254842-44, 15255068 | 240f seed0, one var each: PE hopcap 150 / lr 2e-4 / bs16 / fb-points 3 | ep13-19: pe150 1.207, lr2e4 1.081, bs16 1.281, fb3 1.208(ep5) | ALL current-loss-on variants stuck >=1.0 (worse than null) while vonly=0.82. The knob is the LOSS (drop I), not PE/lr/bs/fb. Mid-run, finals pending but trend unambiguous |
